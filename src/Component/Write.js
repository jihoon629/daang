    ...
    <div className="product-form-container">
      <div className="product-form">
        ...
        <div className="image-upload-container">
          ...
          <input type="file" accept="image/*" onChange={(e) => setProduct({
                ...product,
        ...
        <div className="form-fields">
          ...
          <div>
            ...
            <div className="checkbox-container">
              <input type="checkbox" id="priceNegotiable" name="priceNegotiable" onChange={handleChange} checked={product.priceNegotiable}/>
